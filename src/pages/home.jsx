    ...
    render(){
        ...
        <div className="home" >
           ...
           <Grid className="text-contain" container direction = "column" justify = "space-evenly" alignItems = "center">
                <div id="text">
                    <h1 className="fadeIn1s">WWII Aircraft Recognition</h1>
                    <h6 className="fadeIn2s"><i>Aviation made some massive advancements during WWII, how many do you know?</i></h6>
                </div>

                <div style={{ maxHeight: "120px", width:"10rem"}}>
                <br/>
                <Button className="fadeOnHover fadeIn3s"  variant="contained" component={Link} to={"/leaderboard"}>Leaderboard</Button>
                <br/><br/>
            ...
            <Grid style={{ marginTop: this.state.mobileComp, display: this.state.disp, paddingTop: "20px", paddingBottom: "20px"}} container direction = "column" justify = "space-evenly" alignItems = "center" className="about-project">
                <Grid className="header-italic"> {/*Header*/}
                    <div >
                        <center>
                ...
                <Grid>
                    <p className="about-para"> This project was created for Aviation History and Literature, Second Semester, for the 2020-2021 school year.
                        ...
                        Players with the most points will go up onto the Leaderboard. At the end of the game, you will get to see the planes you saw and learn a little about them.<br/>
                        Was this created using best practices? No. Did I spend too much time working on this? Yes. Did I remove a bunch of the features so that I could maintain this better 5 years later? Yes.
                        Is it still fun? Yes. Enjoy.
                    </p>
                </Grid>
            </Grid>
            <br/>
